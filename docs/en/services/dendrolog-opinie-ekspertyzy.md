...
**Expert assessments are preceded by appropriate tree examinations using various methods depending on the case; we apply all currently recognized tree examination methods – from simple examinations to complex and specialized ones requiring the use of specialist equipment**

Opinions and dendrology expert assessments are documents providing advanced knowledge about the sanitary condition of a tree, its stability, and resistance of the trunk to breakage or uprooting with the root ball. They contain expert recommendations for further handling of the tree. We prepare such documents both within the city of Wrocław and across the entire area of Poland!

**Dendrology opinion**, prepared by a dendrologist, is a detailed document concerning the assessment of a tree's health condition by means of visual tree assessment method and using basic equipment such as a probe and measuring instruments.
