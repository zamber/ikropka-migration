...
Below you will find **72 completed projects** in the field of landscape architecture.

### Search for a Project

<div class="portfolio-search">
  <input type="text" id="search-input" placeholder="Search project by name, location or description..." />
...
<div class="portfolio-filters">
  <a href="#all" class="filter-btn active" data-filter="all">All (72)</a>
  <a href="#projekty" class="filter-btn" data-filter="projekty">Projects</a>
  <a href="#zabytkowe" class="filter-btn" data-filter="zabytkowe">Historic Monuments</a>
  <a href="#szkolenia" class="filter-btn" data-filter="szkolenia">Training</a>
</div>
