---
category: services
description: Stellungnahmen und dendrologische Gutachten, erarbeitet von erfahrenen
...
**Gutachten gehen entsprechende Baumuntersuchungen mit verschiedenen, fallabhängigen Methoden voraus; wir wenden alle derzeit anerkannten Baumuntersuchungsmethoden an – von einfachen Untersuchungen bis hin zu komplexen und spezialisierten, die den Einsatz spezieller Geräte erfordern**

Stellungnahmen und dendrologische Gutachten sind Ausarbeitungen, die fundierte Kenntnisse über den Sanitärzustand des Baumes, seine Stabilität sowie die Widerstandsfähigkeit des Stammes gegen Bruch oder das Umstürzen mit dem Wurzelballen vermitteln. Sie enthalten Empfehlungen von Experten für das weitere Vorgehen mit dem Baum. Derartige Ausarbeitungen führen wir sowohl im Stadtgebiet von Wrocław als auch im gesamten Gebiet Polens durch!

**Eine dendrologische Stellungnahme**, die ein Dendrologe erstellt, ist eine detaillierte Ausarbeitung zur Bewertung des Gesundheitszustandes des Baumes mittels visueller Baumbewertung sowie unter Verwendung grundlegender Geräte wie z. B. einer Sonde und Messgeräten.
