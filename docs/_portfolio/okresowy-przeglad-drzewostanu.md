...
project:
  area: 2,72 ha
  client: Zespół Szkół Nr 3 we Wrocławiu
  location: Wrocław, dolnośląskie
  scope: Przegląd drzewostanu pod kątem bezpieczeństwa (inwentaryzacja dendrologiczna
    z projektem gospodarki drzewostanem)
  status: Zrealizowany
  year: '2016'
title: Okresowy przegląd drzewostanu na terenie szkoły
---
...
Projekt realizowany we Wrocławiu, dolnośląskie.
