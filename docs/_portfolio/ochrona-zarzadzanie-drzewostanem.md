...
featured_image: {{ site.baseurl }}/assets/images/portfolio/ochrona-zarzadzanie-drzewostanem/main.jpg
gallery:
- alt: Uczestnicy szkolenia „Drogi dla Natury” w Nowych Skalmierzycach
  image_path: {{ site.baseurl }}/assets/images/portfolio/ochrona-zarzadzanie-drzewostanem/Szkolenie-Nowe-Skalmierzyce-zdj-1-1.jpg
- alt: Praktyczne zajęcia z diagnostyki drzew
  image_path: {{ site.baseurl }}/assets/images/portfolio/ochrona-zarzadzanie-drzewostanem/Szkolenie-Nowe-Skalmierzyce-zdj-2.jpg
- alt: Pielęgnacja drzew metodą alpinistyczną
  image_path: {{ site.baseurl }}/assets/images/portfolio/ochrona-zarzadzanie-drzewostanem/Szkolenie-Nowe-Skalmierzyce-zdj-3.jpg
- alt: Inwentaryzacja pomnikowego drzewa
  image_path: {{ site.baseurl }}/assets/images/portfolio/ochrona-zarzadzanie-drzewostanem/Szkolenie-Nowe-Skalmierzyce-zdj-4.jpg
layout: single
permalink: /portfolio/ochrona-zarzadzanie-drzewostanem/
project:
  client: Fundacja EkoRozwoju
  location: Nowe Skalmierzyce, wielkopolskie
  scope: Organizacja szkolenia w ramach programu „Drogi dla Natury”
  status: Zrealizowany
  year: '2016'
title: Ochrona i zarządzanie drzewostanem
---

{% include gallery %}

Szkolenie „Drzewa w otwartym krajobrazie – instrukcja obsługi” w Nowych Skalmierzycach trwało dwa dni. Dużym zainteresowaniem cieszyły się głównie tematy związane z wycinką drzew i dobrymi praktykami oraz diagnostyka drzewa, w tym wyjście w teren.


## Opis szkolenia

Podczas szkolenia poruszono tematy z zakresu znaczenia i funkcji zadrzewień przydrożnych oraz diagnostyki i przyrodniczej waloryzacji drzew.
