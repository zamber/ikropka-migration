...
project:
  area: 6782.5 m²
  client: ansee consulting
  location: Wrocław, dolnośląskie
  scope: Plan ochrony drzew na placu budowy poprzedzony operatem dendrologicznym
  status: Zrealizowany
  year: '2014'
title: PLAN OCHRONY DRZEW
---
...
Teren opracowania położony jest w ścisłym centrum zabytkowego Starego Miasta, na Wyspie Piasek, w obszarze ochrony konserwatorskiej. Wymagało to ścisłej współpracy z konserwatorem zabytków oraz szczegółowej inwentaryzacji dendrologicznej przed rozpoczęciem prac projektowych.


## Rozwiązania

Opracowano kompleksowy plan ochrony drzew na placu budowy oraz projekt odtworzeniowy. Wytyczono tymczasowe drogi piesze i dla maszyn, przebieg ogrodzeń oraz miejsca składowania materiałów budowlanych. Przygotowano również projekt odtworzenia nasadzeń krzewów usuniętych z powodu kolizji z placem budowy.
