...
- alt: Wizualizacja projektu nasadzeń rodzimych w krajobrazie rolniczym powiatu głubczyckiego
  image: /assets/images/portfolio/ksztaltowanie-bioroznorodnosci-rodzime-nasadzenia-krajobrazie-rolniczym/GLUBCZYCE-DO-PORTFOLIO-2-scaled.jpg
...
- alt: Detal nasadzeń tworzących siedliska dla ptaków
  image: /assets/images/portfolio/ksztaltowanie-bioroznorodnosci-rodzime-nasadzenia-krajobrazie-rolniczym/layout_slider_do-500KB-1-3.jpg
...
project:
  client: Powiat Głubczycki, ul. Kochanowskiego 15, 48-100 Głubczyce
  location: Powiat Głubczycki, Opolskie
  scope: Inwentaryzacja dendrologiczna z projektem gospodarki drzewostanem, analizy,
    koncepcja projektowa połączeń korytarzy ekologicznych, projekt wykonawczy zieleni,
    kosztorysy.
  status: Zrealizowany
  year: '2025'
title: KSZTAŁTOWANIE BIORÓŻNORODNOŚCI I RODZIME NASADZENIA W KRAJOBRAZIE ROLNICZYM
---
...
Głównym wyzwaniem była silna defragmentacja siedlisk w krajobrazie o wybitnie agrarnym charakterze. Prowadzone od lat procesy scalania gruntów rolnych oraz monokultury uprawowe doprowadziły do znacznego zubożenia bioróżnorodności i zjawiska izolacji fauny.

Dodatkowym problemem była obecność inwazyjnych gatunków obcych (IGO) na obszarze objętym opracowaniem. Wykonana inwentaryzacja dendrologiczna wykazała obecność m.in. klonu jesionolistnego, jesionu pensylwańskiego oraz orzecha włoskiego – roślin zaplanowanych do usunięcia, aby chronić cenne siedliska przed degradacją i wypieraniem flory rodzimej.
...
Podstawą skutecznego myślenia siedliskowego w tym założeniu jest rygorystyczny dobór rodzajów i gatunków roślin, ściśle oparty na wytycznych z raportu przyrodniczego. Zgodnie z zaleceniami ekspertów – biologów, wprowadzono gatunki roślin uznane za optymalne dla tworzenia remiz i bezpiecznych miejsc lęgowych, m.in. rodzimą dziką różę, głóg i tarninę, a także drzewa owocowe, takie jak grusza i śliwa. Ciernista struktura tych krzewów gwarantuje gąsiorkom fizyczne bezpieczeństwo oraz przestrzeń do tworzenia charakterystycznych „spiżarni”, natomiast obfite kwitnienie i owocowanie stanowi nieoceniony pożytek dla owadów i innych ptaków, budując stabilną bazę pokarmową.
...
10) wsparcie dla lokalnej gospodarki w zakresie agroturystyki, produkcji lokalnej żywności czy usług ogrodniczych.

Projekt „Ochrona różnorodności Biologicznej powiatu Głubczyckiego” jest współfinansowany ze środków Europejskiego Funduszu Rozwoju Regionalnego w ramach programu Fundusze Europejskie dla Opolskiego na lata 2021-2027. Projekt w partnerstwie: Powiat Głubczycki i Skarb Państwa Państwowe Gospodarstwo Leśne Lasy Państwowe Nadleśnictwo Prudnik.
