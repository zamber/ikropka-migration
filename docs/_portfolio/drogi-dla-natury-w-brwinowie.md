---
category: szkolenia
description: Szkolenie „Drogi dla Natury” w Brwinowie – IKROPKA uczyła inwentaryzacji
  i ochrony drzew przydrożnych oraz zarządzania drzewostanem alejowym.
featured_image: {{ site.baseurl }}/assets/images/portfolio/drogi-dla-natury-w-brwinowie/Szkolenie-Brwin-w-slider-111.jpg
gallery:
- alt: Szkolenie Drogi dla Natury w Brwinowie
  image_path: {{ site.baseurl }}/assets/images/portfolio/drogi-dla-natury-w-brwinowie/Szkolenie-Brwin-w-zdj-1-1.jpg
- alt: Uczestnicy szkolenia przy drzewach przydrożnych
  image_path: {{ site.baseurl }}/assets/images/portfolio/drogi-dla-natury-w-brwinowie/Szkolenie-Brwin-w-zdj-2.jpg
- alt: Praktyczne zajęcia podczas szkolenia
  image_path: {{ site.baseurl }}/assets/images/portfolio/drogi-dla-natury-w-brwinowie/Szkolenie-Brwin-w-zdj-3.jpg
- alt: Inwentaryzacja drzewostanu alejowego
  image_path: {{ site.baseurl }}/assets/images/portfolio/drogi-dla-natury-w-brwinowie/Szkolenie-Brwin-w-zdj-4.jpg
layout: single
permalink: /portfolio/drogi-dla-natury-w-brwinowie/
project:
  client: Fundacja EkoRozwoju
  location: Brwinów, mazowieckie
  scope: Organizacja szkolenia w ramach programu „Drogi dla Natury”
  status: Zrealizowany
  year: '2016'
title: Drogi dla Natury w Brwinowie
---
